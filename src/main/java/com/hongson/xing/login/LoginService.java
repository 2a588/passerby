...
package com.hongson.xing.login;

import com.jfinal.aop.Inject;
import com.hongson.xing.common.authcode.AuthCodeService;
import com.hongson.xing.common.kit.EmailKit;
import com.hongson.xing.common.model.Account;
import com.hongson.xing.common.model.AuthCode;
import com.hongson.xing.common.model.Session;
...
public class LoginService {
	...
	public Ret sendRetrievePasswordAuthEmail(String userName) {
		...
		String authCode = authCodeSrv.createRetrievePasswordAuthCode(account.getId());

		String title = "JFinal 密码找回邮件";
		String content = "在浏览器地址栏里输入并访问下面链接即可重置密码：\n\n"
				+ " https://jfinal.com/login/retrievePassword?authCode="
				+ authCode;
	...
	public Ret retrievePassword(String authCodeId, String newPassword) {
		...
		AuthCode authCode = authCodeSrv.getAuthCode(authCodeId);

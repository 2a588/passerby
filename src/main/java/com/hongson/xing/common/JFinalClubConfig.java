...
package com.hongson.xing.common;

import com.alibaba.druid.filter.stat.StatFilter;
import com.alibaba.druid.wall.WallFilter;
import com.hongson.xing._admin.auth.AdminAuthInterceptor;
import com.hongson.xing._admin.auth.AdminAuthKit;
import com.hongson.xing._admin.common.PjaxInterceptor;
import com.hongson.xing._admin.permission.PermissionDirective;
import com.hongson.xing._admin.role.RoleDirective;
import com.hongson.xing.common.handler.UrlSeoHandler;
import com.hongson.xing.common.interceptor.LoginSessionInterceptor;
import com.hongson.xing.common.kit.DruidKit;
...
public class JFinalClubConfig extends JFinalConfig {
	...
	public void configEngine(Engine me) {
		 ...
		 *    可代替
		 *    com.hongson.xing.common.model.Feedback::REPORT_BLOCK_NUM
		 */
	...
	public void configPlugin(Plugins me) {
		...
		arp.addSqlTemplate("/com/hongson/xing/common/_all_sqls.sql");
